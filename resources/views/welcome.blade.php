...
<main>
    ...
    <section class="right-slant-shape bg-primary pb-10 pt-4" data-cue="fadeIn">
        ...
        <div class="position-absolute z-1 w-100 text-center top-25 mt-n8" data-cue="zoomIn">
            <img src="{{ asset('images/perosnal-portfolio/personal-profile-img.jpg') }}" alt="avatar" class="rounded-circle shadow-sm border border-white border-4" />
        </div>
    </section>
    <!--hero section end-->
                        ...
                        <a href="#!">
                            <div class="card card-lift">
                                <div class="card-body pb-0">
                                    ...
                                    <img src="{{ asset('images/perosnal-portfolio/personal-portfolio-img-3.jpg') }}" alt="portfolio" class="img-fluid rounded-top shadow-sm" />
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="#!">
                            <div class="card card-lift">
                                <div class="card-body pb-0">
                                    ...
                                    <img src="{{ asset('images/perosnal-portfolio/personal-portfolio-img-2.jpg') }}" alt="portfolio" class="img-fluid rounded-top shadow-sm" />
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="#!">
                            <div class="card card-lift">
                                <div class="card-body pb-0">
                                    ...
                                    <img src="{{ asset('images/perosnal-portfolio/personal-portfolio-img-1.jpg') }}" alt="portfolio" class="img-fluid rounded-top shadow-sm" />
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card bg-danger bg-opacity-10 border-0 mb-5" data-cue="fadeIn" data-delay="500">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="{{ asset('images/personal-svg/html5.svg') }}" alt="html" />
                                    </div>
                                    <div class="mb-4">
                                        <h3>HTML & CSS</h3>
                            ...
                            <div class="card bg-warning bg-opacity-10 border-0 mb-5 mb-lg-0" data-cue="fadeIn" data-delay="1000">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="{{ asset('images/personal-svg/figma.svg') }}" alt="html" />
                                    </div>
                                    <div class="mb-4">
                        ...
                        <div class="col-md-6 mt-md-5">
                            <div class="card bg-info bg-opacity-10 border-0 mb-5" data-cue="fadeIn" data-delay="1500">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="{{ asset('images/personal-svg/react.svg') }}" alt="html" />
                                    </div>
                                    <div class="mb-4">
                                        <h3>React</h3>
                                        <p class="mb-0">Nulla vitae elit libero, a pharetra auguc id elit non mi porta gravida.</p>
                            ...
                            <div class="card bg-success bg-opacity-10 border-0 mb-5 mb-lg-0" data-cue="fadeIn" data-delay="2000">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="{{ asset('images/personal-svg/nodejs.svg') }}" alt="html" />
                                    </div>
                                    <div class="mb-4">
                                        <h3>Node.js</h3>
                                        <p class="mb-0">Nulla vitae elit libero, a pharetra auguc id elit non mi porta gravida.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                <div class="mb-3">
                                    <img src="{{ asset('images/process-icon/LightbulbFilament.svg') }}" alt="bulb" />
                                </div>
                        ...
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                <div class="mb-3">
                                    <img src="{{ asset('images/process-icon/PencilCircle.svg') }}" alt="bulb" />
                                </div>
                        ...
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                <div class="mb-3">
                                    <img src="{{ asset('images/process-icon/BracketsCurly.svg') }}" alt="bulb" />
                                </div>
                        ...
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                <div class="mb-3">
                                    <img src="{{ asset('images/process-icon/Rocket.svg') }}" alt="bulb" />
                                </div>
