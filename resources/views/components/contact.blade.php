<section id="contact" class="py-lg-9 py-5 bg-primary-blend-gradient text-dark">
    <div class="container">
        <div class="row">
                ...
                <div class="row g-lg-10 gy-5 align-items-center">
                    ...
                    <div class="col-md-6" data-cue="zoomIn">
                        <div class="mb-7 text-center text-lg-start">
                            <div class="mb-3">
                                <img src="{{ asset('images/avatar/profile.jpg') }}" alt="Thomaz Machado" class="avatar avatar-xl rounded-circle" />
                            </div>

                            <h3 class="mb-0">Thomaz Machado</h3>
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ms-2">
                                ...
                                <small>São Luís, MA - Brazil</small>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div>
                            ...
                            <div class="ms-2">
                                ...
                                <small>
                                    <a href="#!" class="text-reset">contact@thomazmachado.com.br</a>
                                    <span class="ms-lg-3"><a href="#!" class="text-reset">thomaz@xfera.tech</a></span>
                                </small>
                            </div>
                        </div>
                        <div>
                            <a href="https://www.instagram.com/thomazsm_/" class="text-reset btn btn-instagram btn-icon">
                            ...
                            <a href="https://github.com/thomazdsm" class="text-reset btn btn-github btn-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 496 512">
                            ...
                            <a href="https://www.linkedin.com/in/thomaz-smachado/" class="text-reset btn btn-linkedin btn-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 448 512">
